      ...
      <div style={{ width: '100%', top: 0, left: 0 }}>
        ...
        >
          <div style={{ margin: '0 177px' }}>
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 264 }}>
        ...
        <div className={cx('profile')}>
          ...
          <table style={{ fontSize: '16px', width: '100%', paddingTop: 34 }}>
            ...
            <tr>
              ...
              <td className={cx('background-table')}>
                <Link className={cx('padding-table', 'mail')} to="mailto:contact@teqnological.asia">
